...
const MovieCard: React.FC<MovieCardProps> = ({ data }) => {
  ...
  return (
    <div className="cursor-pointer group bg-zinc-900 col-span relative h-[12vw]">
      <img
      onClick={() => router.push(`/watch/${data?.id}`)}
        className="object-cover transition duration shadow-xl rounded-md group-hover:opacity-90 sm:group-hover:opacity-0 delay-300 w-full h-[12vw]"
      ...
      <div className="
        ...
        group-hover: -translate-z-[2vw]
        group-hover:opacity-100
      ">
        <img className="cursor-pointer object-cover transiton duration shadow-xl rounded-t-md w-full h-[12vw]" src={data.thumbnailUrl} alt="thumbnail" />
        <div className="
            z-10
            bg-zinc-800
            p-2
